...
public class UpdateS extends javax.swing.JFrame {
   ...
   ObjectInputStream ios;
    ...
    Socket socket;
    Sach book;
    public UpdateS(Socket socet,ObjectInputStream ios, ObjectOutputStream oos, DataInputStream dataIn, DataOutputStream dataOut,Sach sach) {
        setVisible(true);
        initComponents();
       this.ios = ios;
        this.oos = oos;
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        ...
        try {
            oos.writeObject(book);// cap nhat thong tin sach
            int i =dataIn.readInt();
            if(i==1){
                 JOptionPane.showMessageDialog(ThongBao, " cập nhật thong tin thanh cong");//thong bao thanh cong
