 ...
 * @author ADMIN
 */
public class UpdateBD extends javax.swing.JFrame {
ObjectInputStream ios;
     ...
     */
    public UpdateBD(Socket socet,ObjectInputStream ios, ObjectOutputStream oos, DataInputStream dataIn, DataOutputStream dataOut,BanDoc bd) {
        setVisible(true);
        initComponents();
        this.ios = ios;
        this.oos = oos;
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        ...
        try {
            oos.writeObject(bandoc);// cap nhat thong tin sach
            int i=dataIn.readInt();
            if(i==1){
                JOptionPane.showMessageDialog(ThongBao, " sua thong tin thanh cong");//thong bao thanh cong
                ManageView manage = new ManageView(socket,ios, oos,dataIn,dataOut);//tro ve trang chu
                setVisible(false);
            }else{
                JOptionPane.showMessageDialog(ThongBao, " sua thong tin that bai");
                setVisible(true);
            }
